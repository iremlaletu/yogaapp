    ...
    <div className={`w-fit ${className}`}>
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 16 19"
          className="w-7 h-7 justify-end bg-gray-50 group-hover:rotate-90 group-hover:bg-gray-50 text-gray-50 ease-linear duration-300 rounded-full p-2 rotate-45"
        >
          <path
